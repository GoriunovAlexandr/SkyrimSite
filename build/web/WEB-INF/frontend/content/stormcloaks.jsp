            ...
            <div id="wrapper">
                ...
                <div id="content_container">
                    <div id="quest_content">
                        ...
                        <div class="image_content"><img src="./dist/img/quests/stormcloaks/Stormcloaks_Solitude.png" alt="alt1" height="400" width="450"/></div>
                        ...
                        <div class="image_content"><img src="./dist/img/quests/stormcloaks/Jarl-Ulfric-Stormcloak-515x289.jpg" alt="alt1" height="400" width="550"/></div>
                        ...
                        <div class="image_content"><img src="./dist/img/quests/stormcloaks/27492-1-1373838113.jpg" alt="alt1" height="400" width="700"/></div>
                        ...
                        <div class="image_content"><img src="./dist/img/quests/stormcloaks/i7Z1B.jpg" alt="alt1" height="400" width="550"/></div>
                ...
                <div id="show_comment">
                        ...
                        <div>
                            ...
                            <div class="comment_like">
                                <%if(user != null){%>
                                <p><a href="incrementLike?id=<%=showcomment.getId()%>&PAGENAME=stormcloaks"><img src="./dist/img/checkbox.png" alt="alt1" height="14" width="14" /> <%=showcomment.getLike()%>   </a> </p>
                                <%}else{%>
                            ...
                            <div class="delete_comment">
                                <%if(adminUser != null){%>
                                <a href="deletecomment?id=<%=showcomment.getId()%>&PAGENAME=stormcloaks"><img src="./dist/img/delete.png" alt="alt1" height="20" width="20" /></a>
                                <%}%>
                            </div>
                        </div>
                ...
                <div class="comment_filed">
                    <form action="savecomment" method="POST">
                        ...
                        <input type="hidden" name="PAGENAME" value="STORM"/>
