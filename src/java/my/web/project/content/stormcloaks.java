 ...
 * @author user1
 */
public class stormcloaks extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/WEB-INF/frontend/content/stormcloaks.jsp").forward(request, response);
    }
