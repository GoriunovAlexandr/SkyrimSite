 ...
 * @author user1
 */
public class bards_college extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/WEB-INF/frontend/content/bards.jsp").forward(request, response);
    }
