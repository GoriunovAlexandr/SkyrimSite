 ...
 */
package my.web.project.content;
 ...
 * @author user1
 */
public class main_story extends HttpServlet {
     ...
     * @throws ServletException if a servlet-specific error occurs          MAINSTORY
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/WEB-INF/frontend/content/main_story.jsp").forward(request, response);
    }
