 ...
 * @author user1
 */
public class imperial_legion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/WEB-INF/frontend/content/legion.jsp").forward(request, response);
    }
