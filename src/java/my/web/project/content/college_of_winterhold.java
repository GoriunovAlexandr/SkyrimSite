 ...
 * @author user1
 */
public class college_of_winterhold extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/WEB-INF/frontend/content/winterhold.jsp").forward(request, response);
    }
