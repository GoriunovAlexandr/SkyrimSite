 ...
 * @author user1
 */
public class races_bosmer extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/WEB-INF/frontend/content/races_bosmer.jsp").forward(request, response);
