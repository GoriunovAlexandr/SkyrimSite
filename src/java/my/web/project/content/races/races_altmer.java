 ...
 * @author user1
 */
public class races_altmer extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/WEB-INF/frontend/content/races_altmer.jsp").forward(request, response);
    }
