 ...
 * @author user1
 */
public class races_orsimer extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/WEB-INF/frontend/content/races_orsimer.jsp").forward(request, response);
    }
