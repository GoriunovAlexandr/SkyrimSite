 ...
 * @author user1
 */
public class races_breton extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/WEB-INF/frontend/content/races_breton.jsp").forward(request, response);
