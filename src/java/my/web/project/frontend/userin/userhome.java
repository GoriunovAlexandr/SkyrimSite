...
public class userhome extends HttpServlet {
    private static final Logger LOG = Logger.getLogger(userhome.class.getName());
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String pageText = "You Are In USER home page: ";//+userName;//service.getPageText("home");
        ...
        //String requestPage =(String) request.getAttribute("pageName");
       ...
       request.getRequestDispatcher("/WEB-INF/frontend/user/userhome.jsp").forward(request, response);
    }
